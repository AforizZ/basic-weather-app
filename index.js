const apiKey = "64c26f648e03c795c58250a460b7193d";
...
function fetchWeatherData(location) {
    ...
    fetch(apiUrl).then(response => response.json()).then(data => {
        ...
        const dayInfoContainer = document.querySelector('.detaylar');
        dayInfoContainer.innerHTML = `

            <div>
                <span class="title">Yağış</span>
        ...
        for (const dayData of nextDaysData) {
            ...
            const dayAbbreviation = forecastDate.toLocaleDateString('tr', { weekday: 'short' });
...
document.addEventListener('DOMContentLoaded', () => {
    const defaultLocation = 'İstanbul';
